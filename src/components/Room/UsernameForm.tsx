...
function UsernameForm({ canBeClosed, setCanBeClosed }: UsernameFormProps) {
  ...
  const submitHandler = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (isHost) {
      ...
      set(child(playersInRoomRef, playerId), { playerId, username: trimmedInputtedUsername, isHost: true, teamId: null });
    } else {
      set(child(playersInRoomRef, playerId), { playerId, username: trimmedInputtedUsername, isHost: false, teamId: null });
